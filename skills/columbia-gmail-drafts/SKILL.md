---
name: columbia-gmail-drafts
description: Create a reviewable draft in sk5335@columbia.edu through the local draft-only Gmail broker. Use for requests to write, draft, or send an email from that Columbia account.
---

# Columbia Gmail Drafts

Use this workflow only when the user directly asks to write, draft, or send a specific email from `sk5335@columbia.edu`.
...
curl --fail --silent --show-error \
  ...
  --data '{"account":"sk5335@columbia.edu","to":["recipient@example.com"],"cc":[],"bcc":[],"subject":"Subject","body":"Plain-text body"}'
```
